-- Widen source_target.connector_id CHECK to accept 'pinterest' (issue #3201).
--
...
-- 'threads','hn') accepted plus 'pinterest'. 0100 sorts before this file, so
...
CREATE TABLE source_target_pinterest_widen_new (
  id TEXT PRIMARY KEY NOT NULL,
  tracked_entity_id TEXT NOT NULL,
  user_id TEXT NOT NULL,
  connector_id TEXT NOT NULL CHECK (connector_id IN ('website', 'x', 'reddit', 'linkedin', 'rss', 'gdelt', 'bluesky', 'threads', 'hn', 'pinterest')),
...
INSERT INTO source_target_pinterest_widen_new (
...
ALTER TABLE source_target_pinterest_widen_new RENAME TO source_target;
