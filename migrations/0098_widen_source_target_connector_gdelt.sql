-- Widen source_target.connector_id CHECK to accept 'gdelt' (issue #3251).
--
-- Same table-rebuild convention as 0093 (rss widen, issue #2461): SQLite
-- cannot ALTER a CHECK in place, so the table is rebuilt — create the
