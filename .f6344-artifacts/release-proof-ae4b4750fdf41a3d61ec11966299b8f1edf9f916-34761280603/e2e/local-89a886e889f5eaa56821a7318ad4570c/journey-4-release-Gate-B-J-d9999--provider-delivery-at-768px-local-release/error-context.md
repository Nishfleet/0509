...
- Name: journey-4-release.spec.ts >> Gate-B Journey 4 — evidence, reports, sharing, export, and client delivery >> exports and share controls expose plan truth before click and do not claim provider delivery at 768px
