...
- Name: journey-4-release.spec.ts >> Gate-B Journey 4 — evidence, reports, sharing, export, and client delivery >> agency evidence report is client-readable and keyboard reachable at 375px
  ...
  - generic [ref=e4]:
    ...
    - navigation "Workspace sections" [ref=e25]:
      ...
      - link "Briefs" [ref=e27] [cursor=pointer]:
        - /url: /app/briefs
      - link "Account & Billing" [active] [ref=e28] [cursor=pointer]:
        - /url: /app/account
