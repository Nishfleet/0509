...
- Name: journey-4-release.spec.ts >> Gate-B Journey 4 — evidence, reports, sharing, export, and client delivery >> client rooms make empty and gated delivery states explicit before room creation at 1440px
