...
- Name: journey-6-release.spec.ts >> Journey 6 release: recovery across account, support, retention, auth, and team >> recovers concurrent team invites and stale conflicts (mobile)
- Location: e2e/journey-6-release.spec.ts:354:5
...
- main [ref=e2]:
  ...
  - generic [ref=e4]:
    ...
    - status [ref=e35]: Navigated to Team.
    - generic [ref=e37]:
      - generic [ref=e38]:
        - heading "Team" [level=1] [ref=e40]
        - paragraph [ref=e41]: 2 of 3 Agency seats are in use.
      - region [ref=e42]:
        - paragraph [ref=e43]: Workspace seats
        - generic [ref=e45]:
          - heading "2 of 3 seats in use" [level=2] [ref=e46]
          - paragraph [ref=e47]: Teammates share your watchlists, collections, and briefs. Billing stays with you.
        - generic [ref=e48]:
          - generic [ref=e49]:
            - text: Teammate email
            - textbox "Teammate email" [active] [ref=e50]:
              - /placeholder: teammate@agency.com
          - button "Send invite" [ref=e51]
        - generic "Workspace members" [ref=e52]:
          - generic [ref=e53]:
            - generic [ref=e54]:
              - strong [ref=e55]: e2e-active-member@example.invalid
              - paragraph [ref=e56]:
                - text: Joined
                - time [ref=e57]: Sep 4, 2026, 2:00 PM
            - button "Revoke" [ref=e60]
```
