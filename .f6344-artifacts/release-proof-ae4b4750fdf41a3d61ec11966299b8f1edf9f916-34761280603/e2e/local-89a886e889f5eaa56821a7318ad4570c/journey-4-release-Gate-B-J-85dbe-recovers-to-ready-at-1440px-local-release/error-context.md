...
- Name: journey-4-release.spec.ts >> Gate-B Journey 4 — evidence, reports, sharing, export, and client delivery >> client-room delivery stays gated until current evidence is approved, then recovers to ready at 1440px
...
+   Object {
+     "height": 21,
+     "text": "Create client room",
+     "width": 124.890625,
+   },
+   Object {
+     "height": 21,
+     "text": "Review and approve evidence ›",
+     "width": 202.734375,
+   },
+   Object {
+     "height": 21,
  ...
  - generic [ref=f2e4]:
    ...
    - generic [ref=f2e36]:
      - generic [ref=f2e37]:
        ...
        - paragraph [ref=f2e41]: 3 active · 0 archived. Keep reviewed evidence and client context together for handoff.
      - region [ref=f2e42]:
        - generic [ref=f2e43]:
          - generic [ref=f2e44]:
            - paragraph [ref=f2e45]: Active rooms
            - heading "Client delivery" [level=2] [ref=f2e46]
          - generic [ref=f2e47]: 3 rooms
        - generic [ref=f2e48]:
          - group [ref=f2e49]:
            - generic "E2E approval recovery room 1440x900E2E client · Review and approve the current report evidence before sending.Needs setup before client review" [ref=f2e50]:
              - text: E2E approval recovery room 1440x900
            ...
            - generic [ref=f2e52]:
              ...
              - generic "E2E approval recovery room 1440x900 handoff status" [ref=f2e54]:
                - generic [ref=f2e55]:
              ...
              - region "Agency Court Pack" [ref=f2e64]:
                - generic [ref=f2e65]:
                  ...
                  - heading "E2E approval recovery room 1440x900" [level=2] [ref=f2e67]
          ...
          - group [ref=f2e85]:
            - generic "E2E approval recovery room 768x900E2E client · Review and approve the current report evidence before sending.Needs setup before client review" [ref=f2e86]:
              - text: E2E approval recovery room 768x900
              - generic [ref=f2e87]: E2E client · Review and approve the current report evidence before sending.
              - text: Needs setup before client review›
          - group [ref=f2e88]:
            - generic "E2E approval recovery room 375x812E2E client · Review and approve the current report evidence before sending.Needs setup before client review" [ref=f2e89]:
              - text: E2E approval recovery room 375x812
              - generic [ref=f2e90]: E2E client · Review and approve the current report evidence before sending.
              - text: Needs setup before client review›
      - group [ref=f2e91]:
        - generic [ref=f2e92]:
          - generic [ref=f2e93]:
            - strong [ref=f2e94]: Saved context
        ...
        - option "E2E approval recovery room 1440x900"
        - option "E2E approval recovery room 768x900"
        - option "E2E approval recovery room 375x812"
      - group [ref=f2e95]:
        - generic "Archived roomsKept out of the active handoff list0 archived" [ref=f2e96]:
          - generic [ref=f2e97]:
            - strong [ref=f2e98]: Archived rooms
            - text: Kept out of the active handoff list
          - generic [ref=f2e99]: 0 archived
```
