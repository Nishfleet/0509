...
- Name: journey-3-release.spec.ts >> Gate-B Journey 3 — monitoring, alerts, and digests >> setup checklist and first-scan banner keep Free activation honest at 375px
- Location: e2e/journey-3-release.spec.ts:493:5
  ...
  - generic [ref=e4]:
    - complementary "Application" [ref=e5]:
      ...
      - generic [ref=e19]:
        - generic [ref=e20]:
          - text: E
          - generic [ref=e21]: E2E Free First Scane2e-free-firstscan@example.invalid
    ...
    - generic [ref=e36]:
      - generic [ref=e37]:
        ...
        - paragraph [ref=e40]: Welcome back. No brief has been filed yet.
      - region [ref=e41]:
      ...
      - region [ref=e57]:
        - generic [ref=e58]:
          - generic [ref=e59]: Setup · 2 of 4 done
          - heading "Finish the workspace that sends your first brief" [level=2] [ref=e60]
        - link "Capture evidence" [ref=e62] [cursor=pointer]:
          - /url: /app/watchlists
        - list [ref=e63]:
          - listitem [ref=e64]:
            - text: Done
            - generic [ref=e65]:
              - strong [ref=e66]: First competitor
              - text: 1 competitor saved.
          - listitem [ref=e67]:
            - text: Done
            - generic [ref=e68]:
              - strong [ref=e69]: First watchlist
              - text: 1 active watchlist.
          - listitem [ref=e70]:
            - text: Next
            - generic [ref=e71]:
              - strong [ref=e72]: First evidence
              - text: Refresh a watchlist to capture landing-page evidence.
          - listitem [ref=e73]:
            - text: Pending
            - generic [ref=e74]:
              - strong [ref=e75]: First digest
              - text: Digest history appears after monitored changes.
        - paragraph [ref=e76]:
          - text: Your current plan is at its competitor limit.
          - link "View plans" [ref=e77] [cursor=pointer]:
            - /url: /app/billing?source=setup-checklist#plans
        - generic [ref=e78]:
          - link "Search first instead" [ref=e79] [cursor=pointer]:
            - /url: /search
          - link "Add your brand website" [ref=e80] [cursor=pointer]:
            - /url: /app/account#brand-profile
      - region [ref=e81]:
        - paragraph [ref=e82]: Overnight
        - paragraph [ref=e83]: Activation scan is queued. 1 competitor is ready for the activation scan and one first brief. Recurring checks are a paid plan — paid plans check every 3–6 hours.
      - region [ref=e84]:
        - paragraph [ref=e85]: What changed
        - paragraph [ref=e86]: The first check is still pending for at least one active competitor. Changes will appear after a successful scan.
      - region [ref=e87]:
        - paragraph [ref=e88]: Still running
        - generic "Still running" [ref=e89]:
          - generic [ref=e90]:
            - link "Competitors" [ref=e92] [cursor=pointer]:
              - /url: /app/watchlists
            - text: 1 being checked. Next check Mon 14 Sept, 3:00 am UTC.1›
          - generic [ref=e93]:
            - link "Evidence captures" [ref=e95] [cursor=pointer]:
              - /url: /app/billing?source=evidence#top-ups
            - text: 0 of 1 proof captures used in the current billing period.1 left this month›
          - generic [ref=e96]:
            - link "Source access" [ref=e98] [cursor=pointer]:
              - /url: /app/source-access
            - text: Live ad checks aren't configured yet, so searches show labeled sample data.Source setup needed›
          - generic [ref=e99]:
            - link "First check is still waiting" [ref=e101] [cursor=pointer]:
              - /url: /app/watchlists
            - text: Refresh the active watchlist to record a credible proof or an honest no-change baseline.›
      - generic [ref=e102]:
        - generic [ref=e103]: Last check not yet
        - generic [ref=e104]: Next check Mon 14 Sept, 3:00 am UTC
