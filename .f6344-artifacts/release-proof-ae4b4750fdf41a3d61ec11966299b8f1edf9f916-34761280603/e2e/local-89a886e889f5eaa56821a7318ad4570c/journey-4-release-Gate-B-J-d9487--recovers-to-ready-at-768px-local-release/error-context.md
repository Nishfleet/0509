...
- Name: journey-4-release.spec.ts >> Gate-B Journey 4 — evidence, reports, sharing, export, and client delivery >> client-room delivery stays gated until current evidence is approved, then recovers to ready at 768px
  ...
  - generic [ref=f2e4]:
    ...
    - generic [ref=f2e36]:
      - generic [ref=f2e37]:
        ...
        - paragraph [ref=f2e41]: 2 active · 0 archived. Keep reviewed evidence and client context together for handoff.
      - region [ref=f2e42]:
        - generic [ref=f2e43]:
          - generic [ref=f2e44]:
            - paragraph [ref=f2e45]: Active rooms
            - heading "Client delivery" [level=2] [ref=f2e46]
          - generic [ref=f2e47]: 2 rooms
        - generic [ref=f2e48]:
          - group [ref=f2e49]:
            - generic "E2E approval recovery room 768x900E2E client · Review and approve the current report evidence before sending.Needs setup before client review" [ref=f2e50]:
            ...
            - generic [ref=f2e52]:
              ...
              - generic "E2E approval recovery room 768x900 handoff status" [ref=f2e54]:
                - generic [ref=f2e55]:
              ...
              - region "Agency Court Pack" [ref=f2e64]:
                - generic [ref=f2e65]:
                  ...
                  - heading "E2E approval recovery room 768x900" [level=2] [ref=f2e67]
          ...
          - group [ref=f2e85]:
            - generic "E2E approval recovery room 375x812E2E client · Review and approve the current report evidence before sending.Needs setup before client review" [ref=f2e86]:
      ...
      - group [ref=f2e88]:
        - generic [ref=f2e89]:
          - generic [ref=f2e90]:
            - strong [ref=f2e91]: Saved context
      ...
      - group [ref=f2e92]:
        - generic "Archived roomsKept out of the active handoff list0 archived" [ref=f2e93]:
          - generic [ref=f2e94]:
            - strong [ref=f2e95]: Archived rooms
            - text: Kept out of the active handoff list
          - generic [ref=f2e96]: 0 archived
```
