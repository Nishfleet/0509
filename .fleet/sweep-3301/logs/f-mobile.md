# Journey f — mobile (mobile 390×844)
...
- Started: 2026-09-12T23:46:38.316Z — Finished: 2026-09-12T23:46:41.581Z (duration 3.3s)
...
- Content-Security-Policy (full): `default-src 'self'; script-src 'self' https://static.cloudflareinsights.com/beacon.min.js 'nonce-gsey8c9c+sepA1eMDNHtoq4P'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self'; frame-ancestors 'none'; base-uri 'self'; form-action 'self'`
- script-src directive: `script-src 'self' https://static.cloudflareinsights.com/beacon.min.js 'nonce-gsey8c9c+sepA1eMDNHtoq4P'`
...
- per src-less (inline) script: attrs + first 140 chars of body + nonce verdict
  1. attrs: `nonce="gsey8c9c+sepA1eMDNHtoq4P"`
  ...
  2. attrs: `nonce="gsey8c9c+sepA1eMDNHtoq4P"`
  ...
  4. attrs: `nonce="gsey8c9c+sepA1eMDNHtoq4P"`
     ...
     carries THIS response's CSP nonce (undefined): yes
  5. attrs: `nonce="gsey8c9c+sepA1eMDNHtoq4P"`
  ...
  6. attrs: `nonce="gsey8c9c+sepA1eMDNHtoq4P" type="module" async=""`
...
- `.fleet/sweep-3301/screenshots/f-mobile.png` (final settled state, viewport)
