# Journey a — mobile (mobile 390×844)
...
- Started: 2026-09-12T23:45:55.013Z — Finished: 2026-09-12T23:45:59.009Z (duration 4.0s)
...
- Content-Security-Policy (full): `default-src 'self'; script-src 'self' https://static.cloudflareinsights.com/beacon.min.js 'nonce-83BLPiK2+m4DEebWxhtqbT8w'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self'; frame-ancestors 'none'; base-uri 'self'; form-action 'self'`
- script-src directive: `script-src 'self' https://static.cloudflareinsights.com/beacon.min.js 'nonce-83BLPiK2+m4DEebWxhtqbT8w'`
...
- per src-less (inline) script: attrs + first 140 chars of body + nonce verdict
  1. attrs: `nonce="83BLPiK2+m4DEebWxhtqbT8w"`
  ...
  2. attrs: `nonce="83BLPiK2+m4DEebWxhtqbT8w"`
  ...
  4. attrs: `nonce="83BLPiK2+m4DEebWxhtqbT8w"`
     ...
     carries THIS response's CSP nonce (undefined): yes
  5. attrs: `nonce="83BLPiK2+m4DEebWxhtqbT8w"`
  ...
  6. attrs: `nonce="83BLPiK2+m4DEebWxhtqbT8w" type="module" async=""`
...
- `.fleet/sweep-3301/screenshots/a-mobile.png` (final settled state, viewport)
