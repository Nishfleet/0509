# Journey d — mobile (mobile 390×844)
...
- Started: 2026-09-12T23:46:30.539Z — Finished: 2026-09-12T23:46:33.872Z (duration 3.3s)
...
- per src-less (inline) script: attrs + first 140 chars of body + nonce verdict
  1. attrs: `nonce="QbwK7C0Z01D9P/uKJATbNhD6"`
  ...
  2. attrs: `nonce="QbwK7C0Z01D9P/uKJATbNhD6"`
  ...
  6. attrs: `type="application/ld+json"`
     ...
     carries THIS response's CSP nonce (undefined): **NO — nonceless**  ← application/ld+json
  7. attrs: `nonce="QbwK7C0Z01D9P/uKJATbNhD6"`
     ...
     carries THIS response's CSP nonce (undefined): **NO — nonceless**
  8. attrs: `nonce="QbwK7C0Z01D9P/uKJATbNhD6"`
  ...
  9. attrs: `nonce="QbwK7C0Z01D9P/uKJATbNhD6" type="module" async=""`
...
- `.fleet/sweep-3301/screenshots/d-mobile.png` (final settled state, viewport)
