...
- path: `test-results/gate-b-manifest-local-release-local-60c676678032db7d7518d7d4da16c9ac.json`
- `schemaVersion`: `3`
- `status`: `passed`
- `strict`: `true`
- `candidateFingerprint`: `ce7f4a45b0178522d898a852795318e0726f0e06a13d0c8ab28199f24e07d2d9`
- `environment`: `local`
- `serverIdentity`: `local-60c676678032db7d7518d7d4da16c9ac`
- entries: `73`
