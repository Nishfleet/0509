...
- path: `test-results/gate-b-manifest-local-release-local-65bed22bfb4deb0db43c32baefc7442b.json`
- `schemaVersion`: `3`
- `status`: `passed`
- `strict`: `true`
- `candidateFingerprint`: `69d36e445c6b6c96e7fdd784d3608f883ee1522e0c1cffff716cf81b665c8629`
- `environment`: `local`
- `serverIdentity`: `local-65bed22bfb4deb0db43c32baefc7442b`
- entries: `73`
