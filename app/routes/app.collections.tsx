            ...
            <section aria-labelledby="collection-limit-title" className="f9-wk-sec f9-library-limit">
              ...
              <p className="f9-library-note">
                {collectionLimit === 0
                  ...
                  : `You are using all ${collectionLimit} collection${collectionLimit === 1 ? "" : "s"} on this plan. Delete one you no longer need, or compare plans to keep more evidence sets side by side.`}
              </p>
              <Link className="f9-wk-lnk" to="/app/billing?source=collections#plans">
