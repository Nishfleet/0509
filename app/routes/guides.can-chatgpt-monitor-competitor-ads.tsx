 ...
 *
 * The issue-specified slug `/guides/can-ChatGPT-monitor-competitor-ads`
 * (uppercase ChatGPT) stays registered verbatim in app/routes.ts — it 301s
 * to this lowercase canonical under issue #2955's path canonicalization,
 * which serves every public route at exactly one URL shape (lowercase, no
 * trailing slash — pinned by tests/canonical-path.test.ts). The lowercase
 * PATH is what the sitemap, canonical link, og:url, hreflang cluster, and
 * JSON-LD entities declare; the signup-source marker stays lowercase too.
 */
