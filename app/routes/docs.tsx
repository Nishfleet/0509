    ...
    >
      ...
      <PublicDocBlock id="plan-boundaries" title="Plan boundaries">
        ...
        <ul className="f9-doc-list">
          ...
          <li>Scout plan scope: three scheduled watchlists, a six-hour cadence, weekly email briefs, ten collections, and a generous 50 included proof captures each month.</li>
          <li>Starter plan scope: daily briefs, urgent alerts, evidence capture, and exports, with ten watchlists on a three-hour cadence and 250 included proof captures each month.</li>
          <li>Agency plan scope: client reports, share links, PDF delivery, branding, API/MCP access, and team seats, with 2,500 included proof captures each month.</li>
