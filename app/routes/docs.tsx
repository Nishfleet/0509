    ...
    >
      ...
      <PublicDocBlock id="plan-boundaries" title="Plan boundaries">
        ...
        <ul className="f9-doc-list">
          <li>Free plan scope: one competitor with an instant first scan (the activation scan) and one first brief, Meta Ad Library only. No recurring checks or briefs, no Collections, no instant alerts, manual refresh, or exports — scheduled checks and recurring briefs are paid, and paid plans add 3–6 hour checks and more competitors. Never asks for a card.</li>
...
Authorization: Bearer f9_live_...`}</code>
        ...
        <p>
          ...
          limits. The <Link to="/mcp/setup">one-paste MCP setup</Link> has ready-made snippets for
          Claude Desktop, ChatGPT, and pi.
        </p>
      </PublicDocBlock>
