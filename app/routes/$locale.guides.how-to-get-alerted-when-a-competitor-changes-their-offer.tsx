// Buyer-surface locale guide — `/fr/guides/how-to-get-alerted-when-a-competitor-changes-their-offer`,
...
import GuideHowToGetAlertedWhenACompetitorChangesTheirOfferRoute, { meta } from "./guides.how-to-get-alerted-when-a-competitor-changes-their-offer";
import { buyerSurfaceHreflangLinks, canonicalLinks } from "~/lib/seo";

export { meta };

export const links: LinksFunction = () => [
  ...canonicalLinks("/guides/how-to-get-alerted-when-a-competitor-changes-their-offer"),
  ...buyerSurfaceHreflangLinks("guides/how-to-get-alerted-when-a-competitor-changes-their-offer"),
];

export default GuideHowToGetAlertedWhenACompetitorChangesTheirOfferRoute;
