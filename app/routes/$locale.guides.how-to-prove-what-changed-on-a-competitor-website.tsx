// Buyer-surface locale guide — `/fr/guides/how-to-prove-what-changed-on-a-competitor-website`,
...
import GuideHowToProveWhatChangedOnACompetitorWebsiteRoute, { meta } from "./guides.how-to-prove-what-changed-on-a-competitor-website";
import { buyerSurfaceHreflangLinks, canonicalLinks } from "~/lib/seo";

export { meta };

export const links: LinksFunction = () => [
  ...canonicalLinks("/guides/how-to-prove-what-changed-on-a-competitor-website"),
  ...buyerSurfaceHreflangLinks("guides/how-to-prove-what-changed-on-a-competitor-website"),
];

export default GuideHowToProveWhatChangedOnACompetitorWebsiteRoute;
