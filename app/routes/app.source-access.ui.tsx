...
export function SourceAccessRoute() {
  ...
  const statusLabel = data.connection
      ...
      <section className="f9-app-stack">
        <section className="f9-app-panel f9-source-setup">
          ...
          <p className="f9-muted-copy">
            Five to Nine checks public ad and landing-page signals for you. If
            Meta limits access, add your own Meta Ad Library token so this
            account has a backup.
          </p>
          ...
          <div className="f9-status-strip">
            <div>
              ...
              {data.connection && canManageSourceAccess ? (
                ...
                <EmptyState
                  title="No backup Meta access is connected yet."
                  variant="inline"
                />
              ) : (
                <p className="f9-muted-copy">
                  Source access is managed by the account owner.
                </p>
              )}
            </div>
            <div>
              ...
              <strong>
                {formatDiscoveryStatus(data.discoveryStatus.status)}
              </strong>
              <p className="f9-muted-copy">
          ...
          {canManageSourceAccess ? (
            <div className="f9-dashboard-grid">
              <section className="f9-app-panel f9-source-guide">
                ...
                <p className="f9-muted-copy">
                  The token is stored encrypted and only used to check ads for
                  this account.
                </p>
              </section>
