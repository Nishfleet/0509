...
export default function SearchRoute() {
  ...
  return (
    ...
    >
      {/* schema.org WebPage for the public search preview. States only what
          the page already shows — its title, its meta description, and the
          Five to Nine site it belongs to. No results, prices, guarantees, or
          product claims are asserted here. */}
      <script
        {...jsonLdScriptProps(
          webPageJsonLd({
