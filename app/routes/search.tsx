...
export default function SearchRoute() {
  ...
  return (
    ...
    >
      {/* schema.org WebPage: states only what this page shows — its name, its
          canonical URL, and its purpose. Same helpers and relationship as
          /help, /docs and /status; no prices, results, or provider claims. */}
      <script
        {...jsonLdScriptProps(
          webPageJsonLd({
