...
export default function LoginRoute() {
  ...
  return (
    <main className="f9-auth-page">
      {/* Truthful WebPage structured data for the login shell: same
          name/description as the document head, markup only — it never touches
          the sign-in, magic-link, or session behavior below. */}
      <script
        {...jsonLdScriptProps(
          webPageJsonLd({
