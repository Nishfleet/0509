 ...
 * list (Search preview, Pricing, Help, Docs, Status) plus a primary Get
 * started signup CTA and Sign in / Open app — no per-surface improvisation.
 * Uses the `ld-nav*` classes, styled for both `.f9-home` and `.f9-legal-page`
 * containers in app.css. Links are absolute-to-home hashes so Pricing works
 * from any page, not just the landing route.
 */
