 ...
 * list (Search preview, Pricing, Help, Docs, Status) plus account actions:
 * Sign in, the signup CTA (Sign up → /auth/signup), and Open app — no
 * per-surface improvisation. Uses the `ld-nav*` classes, styled for both
 ...
 * route. The signup CTA is a plain `/auth/signup` link: the signup loader
 * already defaults a fresh visitor to `/app#setup-checklist`.
 */
