...
// Pure pricing copy/data lives in the leaf module (issue #2967) so route
// modules can import the helpers without this React chunk. Re-exported here
// for the existing import surface (tests, routes).
export {
  COMPETITOR_PRICE_ANCHORS,
  billingFaqJsonLdEntries,
  planIntentPath,
...
export type { CompetitorPriceAnchor } from "~/components/pricing-copy";
