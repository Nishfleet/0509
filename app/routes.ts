...
export default [
  ...
  route("auth/passkeys/authentication/options", "routes/auth.passkeys.authentication.options.ts"),
  route("auth/passkeys/authentication/verify", "routes/auth.passkeys.authentication.verify.ts"),
  route("auth/passkeys/registration/options", "routes/auth.passkeys.registration.options.ts"),
  route("auth/passkeys/registration/verify", "routes/auth.passkeys.registration.verify.ts"),
