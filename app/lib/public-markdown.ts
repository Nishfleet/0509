...
- The public status page can show coarse aggregate production evidence for recent monitoring, proof capture, digest delivery, Slack delivery, and WhatsApp launch scope when the database is available, without exact activity counts or timestamps.
...
- The public status page can show coarse aggregate production evidence, but the private canaries and manual blockers remain the launch gate.
- Slack webhook URLs are stored encrypted and are not shown again after saving.
