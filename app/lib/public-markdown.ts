...
- Proof capture packs add purchased proof captures that never expire and roll over forever. They do not change monthly included limits or promise unlimited monitoring.
- Generous monthly caps reset each cycle: included proof captures do not roll over. Scheduled scans are included with your plan; saved proof-backed captures use proof captures.
...
- Checkout, plan access, and check limits follow the configured billing provider and visible plan caps; this text does not claim live checkout or provider proof.
- Email delivery is in product scope for eligible accounts; this text does not measure live provider delivery.
- Starter is the recommended plan. Free includes one watchlist with a weekly check and weekly email brief (no proof captures/collections). Paid plans have generous rollover caps: Scout includes 6-hour scans, weekly digest delivery, and 50 proof captures/month; Starter includes 3-hour scans, daily and weekly digest delivery, and 250 proof captures/month; Agency includes top 25 competitors every 3 hours (rest every 6 hours), daily and weekly digests, and 2,500 proof captures/month. Purchased proof captures never expire and roll over forever, included proof captures reset monthly without rollover, and saved proof-backed captures use proof captures.
- Tracking status is labeled honestly as live, recent, delayed, or sample data.
- Recent results must not be described as fresh live results.
- Backup Meta access is optional, owner-provided, tested before saving, stored encrypted, and used only for that account.
