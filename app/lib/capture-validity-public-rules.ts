...
export const CAPTURE_VALIDITY_PUBLIC_RULES: readonly CaptureValidityPublicRule[] = [
  ...
  },
  {
    ...
    why:
      "HTML extraction alone can invent a change a visitor would not see. Headline and form changes alert from signals a missing screenshot cannot fake — the headline is read from the document title, and form presence is a structural signal. No screenshot match for a price, offer, or CTA change: no alert.",
