...
export function connectorHasCustomerPollPath(connectorId: PresenceConnectorId): boolean {
  return connectorId === "website" || connectorId === "rss" || connectorId === "podcast" || connectorId === "gdelt" || connectorId === "threads" || connectorId === "hn" || connectorId === "x" || connectorId === "reddit" || connectorId === "bluesky" || connectorId === "linkedin" || connectorId === "pinterest" || connectorId === "review_sites";
}
