...
export function connectorHasCustomerPollPath(connectorId: PresenceConnectorId): boolean {
  return connectorId === "website" || connectorId === "rss" || connectorId === "gdelt" || connectorId === "threads" || connectorId === "hn" || connectorId === "youtube" || connectorId === "x" || connectorId === "reddit" || connectorId === "bluesky";
}
