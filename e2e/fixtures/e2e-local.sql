...
DELETE FROM discovery_cache_entry WHERE cache_key LIKE 'search-v2:domain:%e2e%' OR query_fingerprint LIKE 'e2e-%'
  OR cache_key LIKE '%:starter-fixture.com:%' OR cache_key LIKE '%text:starter%';
...
INSERT INTO workspace_branding (user_id, brand_name, brand_website, updated_at) VALUES
  ('e2e-starter', 'Starter Fixture Studio', 'https://starter-fixture.com', strftime('%Y-%m-%dT%H:%M:%fZ', 'now')),
...
INSERT INTO discovery_cache_entry (cache_key, provider, route_context, query_fingerprint, country, cursor, payload_json, fetched_at, expires_at, browser_ms_used, created_at, updated_at) VALUES
  ...
  ('search-v2:domain:ridgewallet.com:exact:meta_library_browser:all:page-1', 'meta_library_browser', 'public_search', 'e2e-ridgewallet-exact', 'all', NULL,
    json_object('ads', json_array(
      json_object('metaAdId','e2e-ridge-ca','advertiser','The Ridge','body','Carry less with the Ridge Wallet.','previewHeadline','The Ridge Wallet','previewSubhead','Slim metal wallet','hook','Carry less','offer','Free shipping','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://www.ridgewallet.ca/products/wallet','adSnapshotUrl','https://facebook.com/ads/library/?id=e2e-ridge-ca','countries',json_array('all'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-30 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','Fixture Ridge regional ad.','source','meta_library_browser','analysisFields',json_array()),
      json_object('metaAdId','e2e-ridge-eu','advertiser','Ridge EU','body','Ridge Wallet Europe.','previewHeadline','Ridge Wallet EU','previewSubhead','Carbon fibre wallet','hook','Upgrade your wallet','offer','Launch offer','cta','Buy now','format','video','languageLabel','English','destinationType','website','landingPageUrl','https://ridgewallet.eu/shop','adSnapshotUrl','https://facebook.com/ads/library/?id=e2e-ridge-eu','countries',json_array('all'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-28 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-1 hour'),'active',json('true'),'researchSummary','Fixture Ridge EU regional ad.','source','meta_library_browser','analysisFields',json_array()),
      json_object('metaAdId','e2e-ridge-uk','advertiser','Ridge UK','body','Ridge Wallet UK store.','previewHeadline','Ridge Wallet UK','previewSubhead','Money clip wallet','hook','Slim your pocket','offer','Bundle save','cta','Shop UK','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://ridgewallet.co.uk/buy','adSnapshotUrl','https://facebook.com/ads/library/?id=e2e-ridge-uk','countries',json_array('all'),'platforms',json_array('facebook'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-25 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-2 hours'),'active',json('true'),'researchSummary','Fixture Ridge UK regional ad.','source','meta_library_browser','analysisFields',json_array())
    ),'nextCursor',NULL,'source','meta_library_browser','provider','meta_library_browser','cacheStatus','hit','discoveryStatus','healthy','discoverySummary','Live ad checks are ready.','discoveryFailureClass',NULL),
    strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'), strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '+55 minutes'), 5, strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'), strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'));
...
-- Onboarding epic slice 2 (#3175): competitor auto-population from evidence.
-- e2e-starter's own brand (starter-fixture.com) has cached Meta ads, whose
-- derived keywords seed the keyword probe; that probe carries six real
-- advertisers, so the suggestions panel has >=5 candidates, each with a why
-- and a source. Keys are the EXACT ones the seed builds
-- (buildOwnDomainCacheKey / buildKeywordProbeCacheKey):
--   search-v2:domain:<domain>:exact:<provider>:<country>
--   <provider>:text:<keyword>:<country, lowercased and hyphenated>:page-1
-- The provider segment is `demo`: in the local release server the seed's
-- resolveCommercialDiscoveryProvider finds neither a BROWSER binding nor the
-- E2E_FIXTURE_PROVIDER binding, so it falls through to the no-network `demo`
-- provider (proven by the 3175DBG ownCacheKey line: ...:exact:demo:all:page-1).
-- The seed probes the own ad's own countries (India here), not "all".
INSERT INTO discovery_cache_entry (cache_key, provider, route_context, query_fingerprint, country, cursor, payload_json, fetched_at, expires_at, browser_ms_used, created_at, updated_at) VALUES
  ('search-v2:domain:starter-fixture.com:exact:demo:all:page-1', 'demo', 'public_search', 'e2e-3175-own', 'all', NULL,
    json_object('ads', json_array(json_object('metaAdId','e2e-own-1','advertiser','Starter Fixture Studio','advertiserPageId','900001','body','Starter plans for every studio. Fixture pricing on all plans.','previewHeadline','Starter studio plans','previewSubhead','','hook','Starter studio plans','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://starter-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array())),'nextCursor',NULL,'source','demo','provider','demo','cacheStatus','hit','discoveryStatus','healthy','discoverySummary','Live ad checks are ready.','discoveryFailureClass',NULL),
    strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'), strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '+55 minutes'), 5, strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'), strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes')),
  ('demo:text:starter plans for every studio.:india:page-1', 'demo', 'public_search', 'e2e-3175-probe-1', 'all', NULL,
    json_object('ads', json_array(json_object('metaAdId','e2e-cmp-1','advertiser','Okara','advertiserPageId','900001','body','Fixture competitor ad 1.','previewHeadline','Fixture competitor 1','previewSubhead','','hook','Fixture competitor 1','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://okara-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-2','advertiser','Brightloop','advertiserPageId','900002','body','Fixture competitor ad 2.','previewHeadline','Fixture competitor 2','previewSubhead','','hook','Fixture competitor 2','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://brightloop-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-3','advertiser','Northwind','advertiserPageId','900003','body','Fixture competitor ad 3.','previewHeadline','Fixture competitor 3','previewSubhead','','hook','Fixture competitor 3','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://northwind-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-4','advertiser','Petal','advertiserPageId','900004','body','Fixture competitor ad 4.','previewHeadline','Fixture competitor 4','previewSubhead','','hook','Fixture competitor 4','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://petal-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-5','advertiser','Vantage','advertiserPageId','900005','body','Fixture competitor ad 5.','previewHeadline','Fixture competitor 5','previewSubhead','','hook','Fixture competitor 5','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://vantage-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-6','advertiser','Copperline','advertiserPageId','900006','body','Fixture competitor ad 6.','previewHeadline','Fixture competitor 6','previewSubhead','','hook','Fixture competitor 6','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://copperline-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array())),'nextCursor',NULL,'source','demo','provider','demo','cacheStatus','hit','discoveryStatus','healthy','discoverySummary','Live ad checks are ready.','discoveryFailureClass',NULL),
    strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'), strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '+55 minutes'), 5, strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'), strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes')),
  ('demo:text:starter:india:page-1', 'demo', 'public_search', 'e2e-3175-probe-2', 'all', NULL,
    json_object('ads', json_array(json_object('metaAdId','e2e-cmp-1','advertiser','Okara','advertiserPageId','900001','body','Fixture competitor ad 1.','previewHeadline','Fixture competitor 1','previewSubhead','','hook','Fixture competitor 1','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://okara-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-2','advertiser','Brightloop','advertiserPageId','900002','body','Fixture competitor ad 2.','previewHeadline','Fixture competitor 2','previewSubhead','','hook','Fixture competitor 2','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://brightloop-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-3','advertiser','Northwind','advertiserPageId','900003','body','Fixture competitor ad 3.','previewHeadline','Fixture competitor 3','previewSubhead','','hook','Fixture competitor 3','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://northwind-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-4','advertiser','Petal','advertiserPageId','900004','body','Fixture competitor ad 4.','previewHeadline','Fixture competitor 4','previewSubhead','','hook','Fixture competitor 4','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://petal-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-5','advertiser','Vantage','advertiserPageId','900005','body','Fixture competitor ad 5.','previewHeadline','Fixture competitor 5','previewSubhead','','hook','Fixture competitor 5','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://vantage-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array()),json_object('metaAdId','e2e-cmp-6','advertiser','Copperline','advertiserPageId','900006','body','Fixture competitor ad 6.','previewHeadline','Fixture competitor 6','previewSubhead','','hook','Fixture competitor 6','offer','','cta','Shop now','format','image','languageLabel','English','destinationType','website','landingPageUrl','https://copperline-fixture.com','adSnapshotUrl',NULL,'countries',json_array('India'),'platforms',json_array('Instagram'),'firstSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-3 days'),'lastSeenAt',strftime('%Y-%m-%dT%H:%M:%fZ','now','-5 minutes'),'active',json('true'),'researchSummary','','source','demo','analysisFields',json_array())),'nextCursor',NULL,'source','demo','provider','demo','cacheStatus','hit','discoveryStatus','healthy','discoverySummary','Live ad checks are ready.','discoveryFailureClass',NULL),
    strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'), strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '+55 minutes'), 5, strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'), strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-5 minutes'));
