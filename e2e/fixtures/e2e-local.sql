...
INSERT INTO digest_item (id, digest_run_id, watchlist_id, watchlist_name, event_type, title, summary, metadata_json, created_at) VALUES
  ('e2e-digest-item-1', 'e2e-digest-starter-1', 'e2e-watchlist-starter-1', 'Okara competitor watch', 'ad_new', 'Okara launched a new workflow offer', 'Fixture digest item with verified proof.', '{"eventId":"e2e-event-ad-new-unenriched","proofStatus":"confirmed","priority":"high"}', strftime('%Y-%m-%dT%H:%M:%fZ', 'now', '-30 minutes'));
