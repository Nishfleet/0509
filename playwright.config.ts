  ...
  projects: [
    {
      ...
      testMatch:
          /(local-authenticated|bl030-capture|bl031-capture|bl032-capture|bl033a-capture|bl033b-capture|bl034-capture|bl037-capture|bl038-capture|bl039-capture|bl040-capture)\.spec\.ts/,
      use: {
