  ...
  projects: [
    {
      ...
      // skips itself unless its package flag is set, so ordinary runs are
      // unaffected. BL-034 follows the same opt-in evidence contract.
      testMatch: /(local-authenticated|bl030-capture|bl034-capture)\.spec\.ts/,
      use: {
