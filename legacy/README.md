...
- `supabase/` — Supabase configuration from the pre-Cloudflare backend (also decommissioned in favor of D1 + Better Auth). Kept for reference if you need to recall schema decisions or RLS policies that informed the D1 migrations.
