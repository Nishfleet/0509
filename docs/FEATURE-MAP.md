...
|---|---|---|---|---|---|
| `/` | `app/routes/_index.tsx` | `https://0509.io` | `Tab` to `support@0509.io` in the footer | The landing, in order: ticker, header, hero, mark, standing, how it works, what we watch, price, then the footer. The hero `h1` is "Know where you stand. And who's gaining on you." Each other section is a heading and nothing else. No robots meta. The footer carries `support@0509.io`. | `e2e/smoke.spec.ts` — that `h1`, contact link, no horizontal scroll at 390, no console errors |
