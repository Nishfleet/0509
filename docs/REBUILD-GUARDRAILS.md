...
- The footer address is `support@0509.io`, the address on the landing page. Nish or the deputy handles that mailbox by hand and decides by hand. No form, no ticket, and nothing writes the `takedown` row except that person.
- Measured 2026-09-22T15:34:00Z. Email Routing on `0509.io` is enabled. Rule `support-to-inbox` (`3340891ca5b04942aed88344f41a7ac8`) matches `to` = `support@0509.io`, enabled, priority 1. The action is Worker `0509-support-inbox`. A Worker action has no destination-address verified timestamp. The account has one verified destination address, on a different rule. This rule delivers to the Worker. At 2026-09-22T15:42:50Z the bucket holds `mailboxes/support@0509.io.json`, so the Worker stores the message.
- A request names the subject's domain or handle, and who is asking. If either is missing, reply within 72 hours of that email's arrival and write no row: "We need the subject's domain or handle, and who is asking, before we write a takedown row."
- The 72 hours start when the email arrives at `support@0509.io`. When the email names the subject's domain or handle and who is asking, reply: "We have this request and will handle it by hand within 72 hours of its arrival at support@0509.io." Write the row inside those 72 hours. When the row is written, reply: "We removed <subject> from tracking and from public standing cards on <date>." The row records the subject, the date, and the action.
- A request we do not honour is not a removal of a named subject from our tracking and from our public standing cards. Deleting someone else's account is that case. A takedown removes the subject from tracking by any workspace, which means every workspace. Reply with: "We do not honour this request. We remove a named brand or person from our tracking and from our public standing cards, for every workspace, when the email names their domain or handle and who is asking."
