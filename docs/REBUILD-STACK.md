...
word-diff and mark legs of P3 have shipped (#4001); the per-page transport (P2), the
sweep Workflow (P5), and the surface (P6) remain, and the judgement step (#4333) is separate.
