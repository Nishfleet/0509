...
| Protected PR and deploy | PENDING | Codex/Nish | Staged local work is not live | Required before any final GA verdict | Push branch, open protected PR, wait for checks/review, merge normally, validate main, deploy compatible code, then apply post-deploy cleanup migration and rerun canaries |
