...
- `18cc2b14cd7e064d96dabd6f69ff26dabd85ab02` (`work/20260515-dodo-international-billing`): discard. This predates the current Stytch/Cloudflare Email/Dodo stack, includes stale Better Auth and Resend assumptions, old dependency drift, and broad product/UI edits that are no longer safe to replay.
