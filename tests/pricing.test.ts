...
describe("pricingPlans", () => {
  ...
  it("states the customer-facing proof-capture accounting contract", () => {
    ...
    expect(EVIDENCE_USAGE_CUSTOMER_COPY).toContain("proof capture is saved");
    expect(EVIDENCE_USAGE_CUSTOMER_COPY).toContain("proof-backed change");
    expect(EVIDENCE_USAGE_CUSTOMER_COPY).toContain("Generous monthly caps");
    expect(EVIDENCE_USAGE_CUSTOMER_COPY).toContain("included proof captures don't roll over");
    ...
    expect(EVIDENCE_USAGE_CUSTOMER_COPY).not.toContain("A check is used");
    expect(EVIDENCE_USAGE_CUSTOMER_COPY).not.toContain("Included checks reset every month");
    expect(EVIDENCE_USAGE_CUSTOMER_COPY).not.toContain("Purchased checks never expire");
