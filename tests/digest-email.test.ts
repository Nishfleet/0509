...
describe("buildDigestEmail", () => {
  it("renders up to five top moves grouped by watchlist", () => {
    ...
    expect(email.html).toContain("1 more change are in the full brief");
  ...
  it("renders creative thumbnails and before/after pairs when https urls are sourced", () => {
    const email = buildDigestEmail({
      ...
      items: [
        ...
        {
          ...digestItem("Mamaearth", "CTA changed", 70, "scan_backed", "ev-mamaearth", "website_page_changed"),
          metadata: {
            ...digestItem("Mamaearth", "CTA changed", 70, "scan_backed", "ev-mamaearth", "website_page_changed").metadata,
