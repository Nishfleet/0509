...
describe("Worker security headers", () => {
  ...
  describe("anonymous public HTML caching", () => {
    it("lets anonymous public pages carry short browser caching", () => {
      for (const path of ["/", "/help", "/docs", "/terms", "/ads/nike.com", "/timeline/nike.com", "/compare/magicbrief", "/compare/visualping", "/compare/visualping-ad-library", "/compare/visualping-ad-libraries", "/compare/spyland", "/compare/pulzifi", "/compare/foreplay", "/compare/foreplay-spyder", "/compare/panoramata", "/compare/adspyder", "/compare/adspy", "/switch/magicbrief", "/switch/panoramata", "/switch/visualping", "/methodology"]) {
        const response = withSecurityHeaders(
          htmlResponse(),
