...
describe("edge cache storability guards", () => {
  ...
  it("refuses non-200, cookie-setting, private, and non-HTML responses", () => {
    ...
    // The SSR pricing pages set this themselves; the shared cache must never
    // hold a document whose body depends on the buyer's country/plan.
