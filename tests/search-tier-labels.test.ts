...
// verified or likely row for a bare `q=<brand>` keyword search — never a
// dead-end empty state or a blanket-unmatched list.
const SIX_DOMAINS = [
  {
    query: "allbirds",
    ads: [
      ad({
        ...
        landingPageUrl: "https://www.allbirds.com/products",
      }),
    ],
  },
  {
