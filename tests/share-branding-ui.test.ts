...
describe("shared report agency identity", () => {
	...
	// F2 PDF-rail hide is a rendered getComputedStyle guard — see
	// tests/share-pdf-rail-visibility.test.tsx. Text-parsing app.css cannot
	// catch a selector renamed out from under the live DOM class.
});
