...
// inside the guarded region — but WHICH upstream step threw cannot be
// pinned from here (funnel/app logs are Worker stdout, unreachable
// without Cloudflare tail access). These tests exercise the guard at the two
