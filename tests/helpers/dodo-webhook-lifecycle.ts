...
export function setupDodoWebhookLifecycle() {
	...
	return { mockWebhookDependencies, webhookRequest, deliverWebhook, deliverDodoWebhook, explicitBillingEmailFailure, claimedLifecycleEmailRetry, unverified, expectOutbox, subscriptionGrant, paymentIssueRevocation };
}
