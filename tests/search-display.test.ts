...
describe("formatProofCaptureLabel", () => {
  ...
  it("keeps the seeded Nykaa fixture on the live proof-capture label (#1172)", () => {
    ...
    // deploy. The seeded fixture stays pinned to whatever this helper
    // actually returns for the Nykaa row (URL present, no capturedAt).
