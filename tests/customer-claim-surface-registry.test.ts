...
const expectedCatalogs: Record<CatalogName, readonly string[]> = {
  ...
  presenceSources: ["website", "x", "reddit", "linkedin", "rss", "bluesky", "gdelt", "threads", "hn", "appstore", "pinterest", "youtube", "amazon", "context_dev", "google", "google_ads", "tiktok", "subdomains", "hiring"],
