...
const expectedCatalogs: Record<CatalogName, readonly string[]> = {
  ...
  sitemapPaths: [
    "/", "/search", "/brands",
    "/brands/beauty-personal-care", "/brands/e-commerce", "/brands/optical-eyewear",
    "/brands/saas-software", "/brands/sport-footwear", "/brands/wallet-accessories",
    "/brands/wearables-health",
    "/briefs/weekly", "/sample-brief", "/llms-full.txt", "/guides/how-to-track-competitor-ads",
