...
const expectedCatalogs: Record<CatalogName, readonly string[]> = {
  ...
  presenceSources: ["website", "x", "reddit", "linkedin", "rss", "bluesky", "gdelt", "threads", "hn", "review_sites", "youtube", "amazon", "context_dev", "google", "google_ads", "tiktok", "subdomains", "hiring"],
