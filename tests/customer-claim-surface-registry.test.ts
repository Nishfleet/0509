...
const expectedCatalogs: Record<CatalogName, readonly string[]> = {
  ...
  sitemapPaths: ["/", "/search", "/pricing", "/auth/signup", "/compare/magicbrief", "/compare/meta-ad-library", "/competitor-monitoring", "/help", "/docs", "/api/docs", "/status", "/changelog", "/trust", "/privacy", "/terms"],
  e2eRoutePaths: [
