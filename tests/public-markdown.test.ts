...
describe("public markdown", () => {
  ...
  it("keeps agent-readable content aligned with launch truth", () => {
    ...
    expect(PUBLIC_MARKDOWN).toContain("Proof capture packs add purchased captures that never expire");
    ...
    expect(LLMS_TEXT).toContain("Purchased proof capture packs never expire");
    expect(LLMS_TEXT).toContain("included captures reset monthly without rollover");
