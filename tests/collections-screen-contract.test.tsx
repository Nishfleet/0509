 ...
 * BL-042 removed the shell-owned "+ Add competitor" row entirely. Everything
 * here still renders the real app layout with the real route inside it and
 * counts every ink-filled primary on the screen.
 *
